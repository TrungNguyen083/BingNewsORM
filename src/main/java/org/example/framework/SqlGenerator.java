...
public class SqlGenerator {
    ...
    public static String generateDeleteSql(String tableName, String idColumnName) {
    ...
    public static String generateUpdateSql(String tableName, String[] columnNames, String idColumnName) {
